  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:const  Text("Assalamualikum",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
            ...
            child:Column(
              children:   [
               ...
               const  SizedBox(height: 10,),
                Text(DateFormat.yMMMMEEEEd().format(DateTime.now()),style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 15),),
               const  SizedBox(height: 10,),
          ...
          child: Column(
            children: [
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.touch_app,color: Colors.white,size: 50,),
             ...
             const  SizedBox(height: 20,),
              ...
              const  SizedBox(height: 20,),
              Custombutton(title: "Add Student", ontap: (){
              ...
              Row(
                ...
                Expanded(
                  child: Column(
                    children: [
                      Icon(Icons.timer_outlined,color: Colors.deepPurpleAccent.withOpacity(0.3),size: 60,),
               ...
               Expanded(child:  Column(
                 children: [
                   ...
                   const  SizedBox(height: 5,),
                checkouttime==null?
                  Text(""):totaltime(starttime!,endtime!),
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        return Text(DateFormat.jm().format(DateTime.now()),style: const TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 30),);
      },
    );
  }
}
